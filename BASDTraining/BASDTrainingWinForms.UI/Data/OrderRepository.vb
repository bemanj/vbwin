...
Public Class OrderRepository
    ...
    Public Overrides Function GetData(ByVal entity As IEntity) As BASD.Helper.IEntity
        ...
        Dim _tempOrderList = MyBase.List("[uspGetOrder]", _tempParamList.ToArray())

        Return _tempOrderList.SingleMapToEntity(Of PizzaOrders)().SingleOrDefault()
    ...
    Public Overrides Function GetListData() As System.Collections.Generic.IEnumerable(Of BASD.Helper.IEntity)
        ...
        Return _tempOrderList.SingleMapToEntity(Of PizzaOrders)()
    End Function
